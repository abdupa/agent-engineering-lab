...
function buildGoal(rubric: string): string {
  return [
    ...
    'source text: the cited lines are read from the file and attached for you, and the',
    'tool returns them so you can check the line you cited is the line you meant.',
    '',
